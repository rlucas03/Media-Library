...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$details = trim(filter_input(INPUT_POST,"details",FILTER_SANITIZE_NUMBER_INT));
	...
	if (!isset($error_message)) {
		...
		$mail->addAddress('ryanlucas@btinternet.com', 'Mr Mojo');     // Add a recipient
        ...
        <form method="post" action="suggest.php">
            ...
            <tr>
                ...
                <td><select id="category" name="category">
                	...
                	<option value = "Books"<?php if (isset($category) && $category == "Books") echo " selected"; ?>
